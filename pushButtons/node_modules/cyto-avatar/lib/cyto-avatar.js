...
Graph.prototype.addElementLabel = function(elem, label) {
  return new Promise((resolve, reject) => {
    ...
    elem.style({
          'label': label.text,
          'text-valign': label.style['text-valign'] ? label.style['text-valign'] : 'bottom',
          'text-halign': label.style['text-halign'] ? label.style['text-halign'] : 'center',
          'text-outline-width': label.style['text-outline-width'] ? label.style['text-outline-width'] : "3px",
          'text-outline-color': label.style['text-outline-color'] ? label.style['text-outline-color'] : "#999",
          'text-outline-opacity': label.style['text-outline-opacity'] ? label.style['text-outline-opacity'] : 1,
          'text-margin-y': label.style['text-margin-y'] ? label.style['text-margin-y'] : "3px",
          'font-size': label.style['font-size'] ? label.style['font-size'] :  "14px",
          'color': label.style['color'] ? label.style['color'] : "white",
          'text-background-color': label.style['text-background-color'] ? label.style['text-background-color'] : "rgb(255,255,255)",
          'text-rotation': label.style['text-rotation'] ? label.style['text-rotation'] : 0,
          'text-wrap': label.style['text-wrap'] ? label.style['text-wrap'] : "none",
          'text-max-width': label.style['text-max-width'] ? label.style['text-max-width'] : "100px",
          'text-justification': label.style['text-justification'] ? label.style['text-justification'] : "center"
      });
    resolve (elem);
  })
}
